    ...
    <div class="bashir-rased-services-single-item">
        ...
        <div class="bashir-rased-services-single-area-hover">
            ...
            <div class="bashir-rased-services-hover-title">
                <h4>
                    <?php esc_html_e('graphics design','bashir-rased'); ?>
                </h4>
            </div>
...
<!-- 02. Single Services Item Area Start Here -->
<div class="col-lg-4">
    <div class="bashir-rased-services-single-item">
...
<!-- 02. Single Services Item Area End Here -->

<!-- 03. Single Services Item Area Start Here -->
<div class="col-lg-4">
    <div class="bashir-rased-services-single-item">
...
<!-- 03. Single Services Item Area End Here -->

<!-- 04. Single Services Item Area Start Here -->
<div class="col-lg-4">
    <div class="bashir-rased-services-single-item">
        ...
        <div class="bashir-rased-services-single-area-hover">
            ...
            <div class="bashir-rased-services-hover-title">
                <h4>
                    <?php esc_html_e("wordPress development",'bashir-rased'); ?>
                </h4>
            </div>
            <div class="bashir-rased-services-hover-details">
                <p>
...
<!-- 04. Single Services Item Area End Here -->

<!-- 05. Single Services Item Area Start Here -->
<div class="col-lg-4">
    <div class="bashir-rased-services-single-item">
        ...
        <div class="bashir-rased-services-single-area-hover">
            ...
            <div class="bashir-rased-services-hover-title">
                <h4>
                    <?php esc_html_e("laravel php framework",'bashir-rased'); ?>
                </h4>
            </div>
            <div class="bashir-rased-services-hover-details">
                <p>
...
<!-- 05. Single Services Item Area End Here -->

<!-- 06. Single Services Item Area Start Here -->
<div class="col-lg-4">
    <div class="bashir-rased-services-single-item">
        ...
        <div class="bashir-rased-services-single-area-hover">
            ...
            <div class="bashir-rased-services-hover-title">
                <h4>
                    <?php esc_html_e("24/7 support services",'bashir-rased'); ?>
                </h4>
            </div>
            <div class="bashir-rased-services-hover-details">
                <p>
...
<!-- 06. Single Services Item Area End Here -->